{{-- filepath: d:\xampp\htdocs\Chicking-BJM\resources\views\branch-warehouse\pending-distributions.blade.php --}}
...
@forelse($distributions as $referenceNo => $items)
    ...
    {{-- ✅ FORM wrapper untuk setiap distribution --}}
    <form action="{{ route('branch-warehouse.approve-distribution') }}" 
          method="POST" 
          id="form-{{ $referenceNo }}"
        ...
        <div class="card mb-3 distribution-card" data-reference="{{ $referenceNo }}">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <div class="text-muted small">
                            ...
                            <strong>From:</strong> {{ $firstItem->centralWarehouse->warehouse_name ?? 'N/A' }}
            ...
            <div class="card-body distribution-details" id="details-{{ $referenceNo }}" style="display: none;">
                ...
                <div class="alert alert-info mb-3">
                    ...
                    <strong>Info:</strong>
                    <ul class="mb-0 mt-2">
                        <li><strong>Approve All:</strong> All items will be received into branch stock</li>
                        <li><strong>Approve Selected:</strong> Only checked items with approved quantity will be received</li>
                        <li><strong>Reject:</strong> Distribution will be cancelled and stock will be returned to central</li>
                    </ul>
                </div>

                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        {{-- ✅ Submit buttons untuk approve --}}
                        <button type="submit" 
                                name="action" 
                                value="approve_all"
                    ...
                    <div>
                        {{-- ✅ Button untuk reject (trigger modal) --}}
                        <button type="button" 
...
@empty
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <a href="{{ route('branch-warehouse.show', $warehouse->id) }}" class="btn btn-primary">
...
<div class="modal fade" id="rejectModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('branch-warehouse.reject-distribution') }}" method="POST" id="rejectForm">
                @csrf
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        Stock will be returned to central warehouse.
                    </div>
